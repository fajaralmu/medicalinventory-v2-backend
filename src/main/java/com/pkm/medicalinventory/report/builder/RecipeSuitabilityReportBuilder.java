...
public class RecipeSuitabilityReportBuilder extends BaseReportBuilder {
    ...
    public RecipeSuitabilityReportBuilder(int month, int year, List<Transaction> transactions, String fileName) {
    	super(fileName);
        this.month = month;
        this.year = year;
    ...
    public WritableReport build() {
        ...
        WritableReport report = new XSSFPrintableReport(xwb, fileName);
        return report;
    }
